...
// Use shared normalize/tokens from dxn-chat-core if present, otherwise fall back to local implementations.
var normalize = (typeof window !== 'undefined' && typeof window.normalize === 'function')
  ? window.normalize
  : function (text) {
      return (text || "")
        .toLowerCase()
...
var STOP = (typeof window !== 'undefined' && window.STOP) ? window.STOP : new Set(["ما","هي","هو","من","في","عن","على","الى","هل","كيف","متى","اين","لماذا"]);

var tokens = (typeof window !== 'undefined' && typeof window.tokens === 'function')
  ? window.tokens
  : function (text) {
